...
<body>
  <div id="wrapper">
      ...
      <div class="MainContent well Mensaje">
      		<a href="/Clinica/Administrador/Secretaria/add.php" class="Agregar">Agregar Secretaria</a>
			<table class="table table-bordered table-striped table-hover">
			    ...
			    <tbody>
			      	...
			      	if($con){ 
			          $consulta = "SELECT * FROM administrador WHERE adm_tipo='Secretaria' ORDER BY adm_rut";
			          ...
			          if(pg_num_rows($res)>0)
			          {
			              ...
			              <td>
			                <a class="accion" href="/Clinica/Administrador/Secretaria/edit.php?Rut=<?php echo $row["adm_rut"] ?>">
			                	<i class='icon-pencil'></i>
			                </a>
			                <a class="accion" href="/Clinica/Administrador/Secretaria/enable.php?Rut=<?php echo $row["adm_rut"] ?>">
			                	<i class='icon-ok'></i>
			                </a>
			                <a href="/Clinica/Administrador/Secretaria/delete.php?Rut=<?php echo $row["adm_rut"] ?>">
