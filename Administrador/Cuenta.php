<?php
session_start();
if( !(isset($_SESSION['Rut'])) || $_SESSION['Tipo']=='Medico' || $_SESSION['Tipo']=='Dentista' || $_SESSION['Tipo']=='Cliente' || $_SESSION['Estado']!='t')
...
<body>
  <div id="wrapper">
      ...
      <div class="MainContent well Mensaje">
      	<?php $Rut=$_SESSION['Rut']; ?>
      	<?php $Nombre=$_SESSION['Nombre']; ?>
      	<?php $Apellido=$_SESSION['Apellido']; ?>

		<h3>Cuenta <?php echo $Nombre." ".$Apellido ?></h3>
        ...
        if($con){ 
        	...
        	if($res){ 
        		...
        		<form class="form-horizontal well" method="post" action="/Clinica/Administrador/ActualizarCuenta.php?Rut=<?php echo $Rut ?>">
				    <fieldset>
				        ...
				        <div class="form-actions">
				            ...
				            <button type="reset" class="btn btn-danger" onclick="window.location='/Clinica/Administrador/index.php'">Atras</button>
				        </div>
				    </fieldset>
				</form>
      <?php }else{ ?>
				...
				<a class="btn btn-danger" href="/Clinica/Administrador/index.php">Atras</a>
      <?php }
      		Desconectar($con);
        } 
        else{ ?>
