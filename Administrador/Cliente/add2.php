...
<body>
  <div id="wrapper">
      ...
      <?php
          ...
          if($con){ 
          	...
          	if(pg_num_rows($res1)==0 && pg_num_rows($res2)==0 && pg_num_rows($res3)==0){
	        	$consultaF="INSERT INTO cliente 
	          		VALUES('$Rut','$Nombre','$Apellido','$Correo','$Telefono','$FechaNac','$Direccion','$Password','$Estado')";
    ...
    <?php } ?>
      	  <a class="btn btn-danger" href="/Clinica/Administrador/Cliente/add.php">Atras</a>	
	  </div>
