...
<body>
  <div id="wrapper">
      ...
      <div class="MainContent well Mensaje">
      		<a href="/Clinica/Administrador/Dentista/add.php" class="Agregar">Agregar Dentista</a>
			<table class="table table-bordered table-striped table-hover">
			    ...
			    <tbody>
			      	...
			      	if($con){ 
			          $consulta = "SELECT * FROM medico WHERE med_tipo='Dentista' ORDER BY med_rut";
			          ...
			          if(pg_num_rows($res)>0)
			          {
			              ...
			              <td>
			                <a class="accion" href="/Clinica/Administrador/Dentista/edit.php?Rut=<?php echo $row["med_rut"] ?>">
			                	<i class='icon-pencil'></i>
			                </a>
			                <a class="accion" href="/Clinica/Administrador/Dentista/enable.php?Rut=<?php echo $row["med_rut"] ?>">
			                	<i class='icon-ok'></i>
			                </a>
			                <a href="/Clinica/Administrador/Dentista/delete.php?Rut=<?php echo $row["med_rut"] ?>">
