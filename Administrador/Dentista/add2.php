...
<body>
  <div id="wrapper">
	        	...
	        	<div class="row">
				    <div class="span12">
				        <div class="alert alert-success">
				          ...
				          <p>Dentista Registrado Exitosamente.</p>
				        </div>
				    </div>
				</div>
	  <?php }else{ ?>
    ...
    <?php } ?>
      	  <a class="btn btn-danger" href="/Clinica/Administrador/Dentista/add.php">Atras</a>	
	  </div>
