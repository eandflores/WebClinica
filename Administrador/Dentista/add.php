...
<body>
  <div id="wrapper">
      ...
      <div class="MainContent well Mensaje">
      	<h3>Agregar Nuevo Dentista</h3>
		<form class="form-horizontal well"  onsubmit="return check()" method="post" action="/Clinica/Administrador/Dentista/add2.php">
		    <fieldset>
		        ...
		        <?php
		        	include("../../Conexion.php"); 
          			...
          			if($con){
          				$consulta="SELECT * FROM especialidad WHERE esp_tipo='DENTISTA'"; 
