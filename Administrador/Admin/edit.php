...
<body>
  <div id="wrapper">
      ...
      <div class="MainContent well Mensaje">
		...
		<h3>Actualizar Administrador <?php echo $Rut ?></h3>
        ...
        if($con){ 
        	...
        	if($res){ 
        		...
        		<form class="form-horizontal well" method="post" action="/Clinica/Administrador/Admin/edit2.php?Rut=<?php echo $Rut ?>">
				    <fieldset>
      ...
      <?php }else{ ?>
				...
				<a class="btn btn-danger" href="/Clinica/Administrador/Admin/index.php">Atras</a>
      <?php }
      		Desconectar($con);
        } 
        else{ ?>
