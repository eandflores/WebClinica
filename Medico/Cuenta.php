<?php
session_start();
if( !(isset($_SESSION['Rut'])) || $_SESSION['Tipo']=='Administrador' || $_SESSION['Tipo']=='Secretaria' || $_SESSION['Tipo']=='Cliente' || $_SESSION['Estado']!='t')
      ...
      <div class="MainContent well Mensaje">
        ...
        if($con){ 
        	...
        	if($res){ 
        		...
        		<form class="form-horizontal well" method="post" action="/Clinica/Medico/ActualizarCuenta.php?Rut=<?php echo $Rut ?>">
				    <fieldset>
				        ...
				        <div class="form-actions">
				            ...
				            <button type="reset" class="btn btn-danger" onclick="window.location='/Clinica/Medico/index.php'">Atras</button>
				        </div>
				    </fieldset>
				</form>
      <?php }else{ ?>
				...
				<a class="btn btn-danger" href="/Clinica/Medico/index.php">Atras</a>
      <?php }
      		Desconectar($con);
        } 
        else{ ?>
