      ...
      <div class="MainContent well Mensaje">
        ...
        if($con){ 
        	...
        	if($res){ 
        		...
        		<form class="form-horizontal well" method="post" action="/Clinica/Cliente/ActualizarCuenta.php?Rut=<?php echo $Rut ?>">
				    <fieldset>
				        ...
				        <div class="form-actions">
				            ...
				            <button type="reset" class="btn btn-danger" onclick="window.location='/Clinica/Cliente/index.php'">Atras</button>
				        </div>
				    </fieldset>
				</form>
      <?php }else{ ?>
